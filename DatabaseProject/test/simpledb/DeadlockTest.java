...
public class DeadlockTest extends TestUtil.CreateHeapFile {
  ...
  @Before public void setUp() throws Exception {
    ...
    for (int i = 0; i < 1025; ++i) {
      ...
      empty.insertTuple(tid, Utility.getHeapTuple(i, 2,empty.getId(),empty.numPages()==0?0:empty.numPages()-1));
    }
    ...
    //System.out.println("after flush pages");
    //release the locked on the pages
