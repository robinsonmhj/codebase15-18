                ...
                while (true) {
                    ...
                    try {
                        ...
                        */
						...
						t.setField(0,new IntField((int) (Math.random() * 1000)));

						// fix the bug that, there is recordId in the tuple
						// t.setRecordId(new RecordId(new
						// HeapPageId(tableId,(int)(Math.random()*1000)),(int)(Math.random()*1000)));
						t.setRecordId(new RecordId(new HeapPageId(tableId, 0),(int) (Math.random() * 1000)));
						// System.out.println("====t is null???"+t);
