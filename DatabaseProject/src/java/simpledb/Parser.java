...
public class Parser {
    ...
    public LogicalPlan parseQueryLogicalPlan(TransactionId tid, ZQuery q)
        ...
        //System.out.println("In parseQueryLogicalPlan");
    ...
    public Query handleQueryStatement(ZQuery s, TransactionId tId)
        ...
        try{
        	 lp = parseQueryLogicalPlan(tId, s);
        	 physicalPlan = lp.physicalPlan(tId,TableStats.getStatsMap(), explain);
        }catch(Exception e){
        	e.printStackTrace();
        }
       
       
        //System.out.println("before set setPhysicalPlan");
        query.setPhysicalPlan(physicalPlan);
       // System.out.println("After set setPhysicalPlan");
        query.setLogicalPlan(lp);
        //System.out.println("After set LogigcalPlan");
        ...
        System.out.println("+++++++handleQueryStatement+++query:"+query);
        return query;
    }
    ...
    public void processNextStatement(InputStream is) {
        try {
            ...
            System.out.println(end+"=================readStatement========== using "+(end-start)/1000.00);
            Query query = null;
            if (s instanceof ZTransactStmt)
                ...
                System.out.println(start+"=================I am going to handleDMLStatement==========");
                try {
                    ...
                    System.out.println(end+"=================I am out of handleDMLStatement========== using "+(end-start)/1000.00);
                    start=System.currentTimeMillis();
                    System.out.println(start+"=================I am going to query.execute==========");
                    if (query != null)
                    	query.execute();
                    end=System.currentTimeMillis();
                    System.out.println(end+"=================I am out of query.execute========== using "+(end-start)/1000.00);
    ...
    protected void start(String[] argv) throws IOException {
        ...
        Iterator<Integer> iterator=Database.getCatalog().tableIdIterator();
        while(iterator.hasNext()){
        	...
        	//System.out.println("TupleDesc:"+td);
        	//System.out.println("===============================================");
