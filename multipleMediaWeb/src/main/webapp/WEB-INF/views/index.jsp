...
<div id="wrapper">
	<div id="header">
		...
		<!--  <img id="imagem" src="<c:url value="/images/business.jpg"/>" alt="Business" />-->
		<img id="imagem" src="resources/images/business.jpg" alt="Business" />
		</div>
	...
	<div id="content">
		<div id="col_left">
			...
			<div id="about_us">
				...
				<p><a href="index.html" title="Continue Reading">Continue Reading &raquo;</a></p>
			</div>
			...
			<div id="quote">
			<p><span class="quote">&ldquo; </span>Etiam vehicula, augue eu ultricies dictum, orci nisi suscipit sem, nec sollicitudin neque est ac massa. Phasellus elementum nibh vel odio. Proin orci nulla, viverra tempus, pharetra ut, varius nec, justo. Donec euismod molestie erat. Nulla lobortis bibendum magna. <span class="quote">&ldquo;</span></p>
			...
			<div id="news">
					...
					<ul>
						<li>
							...
							<p><a href="index.html">Read more &raquo;</a></p>
						</li>
						<li>
						...
						<li>
							<p class="archive"><a href="index.html">News archive &raquo;</a></p>
						</li>
					</ul>
		  </div><!--end news-->
		  <div id="contacts">
...
<!--end wrapper-->
<div id="footer"><p>&copy; 2008 <a href="#">Yourcompany.com</a>. Valid CSS &amp; XHTML. Template design by <a href="http://www.chamadigital.com" title="Chama Digital">Chama Digital</a> | Courtesy <a href="http://www.openwebdesign.org" target="_blank">Open Web Design</a>, Thanks to <a href="http://www.seo.us.com" target="_blank">SEO</a></p>
	</div>
</body>
</html>
