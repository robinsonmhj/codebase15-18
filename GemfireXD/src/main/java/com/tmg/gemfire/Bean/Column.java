...
public class Column {
	...
	public Column(String name, String type,int len,String flag,int decimalLen,String defaultValue){
	...
	public String toString() {
		return "Column [name=" + name + ", type=" + type + ", len=" + len
				...
				+ ", decimalLen=" + decimalLen + ", defaultValue="
				+ defaultValue + "]";
	}
