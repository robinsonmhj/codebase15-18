...
Create table ods."BENEFIT_GROUP_NAME_1"(
...
Create table ods."BENEFIT_GROUPS_1"(
    grp_id bigint NOT NULL,
...
Create table ods."BENEFIT_PACKAGE_1"(
    bene_pkg_id bigint NOT NULL,
    ver bigint NOT NULL,
    client_id bigint NOT NULL,
...
Create table ods."BILLING_ENTITY_1"(
    bill_ent_id bigint NOT NULL,
    ver bigint NOT NULL,
    client_id bigint NOT NULL,
...
Create table ods."BILLING_RECONCILIATION_1"(
    bill_ent_id bigint NOT NULL,
...
Create table ods."BILLING_SCHEDULE_1"(
...
Create table ods."BILLING_SOURCE_1"(
    bill_ent_id bigint NOT NULL,
...
Create table ods."CHARGE_ITEM_1"(
    bill_ent_id bigint NOT NULL,
...
Create table ods."CLIENT_REFERENCE_DATA_1"(
...
Create table ods."COB_CLAIM_DIAGNOSIS_1"(
    prsn_id bigint NOT NULL,
...
Create table ods."COB_ORGANIZATION_PERSON_1"(
    prsn_id bigint NOT NULL,
    prsn_cob_id bigint NOT NULL,
...
Create table ods."COMMUNICATION_1"(
...
Create table ods."DIAGNOSIS_CODE_1"(
...
Create table ods."ELECTRONIC_ADDRESS_1"(
    cntc_id bigint NOT NULL,
...
Create table ods."ENTITY_BANK_ACCOUNT_1"(
    bill_ent_id bigint NOT NULL,
...
Create table ods."EXPLANATION_CODE_1"(
...
Create table ods."GENERAL_LEDGER_1"(
    bill_ent_id bigint NOT NULL,
...
Create table ods."GROUP_RELATION_1"(
    grp_id bigint NOT NULL,
...
Create table ods."LINE_ADDITIONAL_DIAGNOSIS_1"(
    prsn_id bigint NOT NULL,
    clm_id bigint NOT NULL,
...
Create table ods."LINE_DISALLOW_EXPLANATION_1"(
    prsn_id bigint NOT NULL,
    clm_id bigint NOT NULL,
    seq_num INTEGER NOT NULL,
...
Create table ods."LINE_PROCEDURE_MODIFIER_1"(
    prsn_id bigint NOT NULL,
    clm_id bigint NOT NULL,
    seq_num INTEGER NOT NULL,
...
Create table ods."MARX_CALENDAR_1"(
...
Create table ods."ORGANIZATION_CODE_1"(
...
Create table ods."ORGANIZATION_CONTACT_TYPE_1"(
    org_id bigint NOT NULL,
    cntc_typ_ref_id bigint NOT NULL,
...
Create table ods."ORGANIZATIONS_1"(
    org_id bigint NOT NULL,
    ver bigint NOT NULL,
    client_id bigint NOT NULL,
    org_nm varchar(80),
...
Create table ods."PERSON_CODE_1"(
    prsn_id bigint NOT NULL,
    cd_val_id bigint NOT NULL,
...
Create table ods."PERSON_CONTACT_1"(
    prsn_id bigint NOT NULL,
    cntc_id bigint NOT NULL,
...
Create table ods."PERSON_EVENT_1"(
...
Create table ods."PERSON_LEP_EVENT_1"(
    prsn_id bigint NOT NULL,
...
Create table ods."PERSON_LEP_PROFILE_1"(
    prsn_id bigint NOT NULL,
...
Create table ods."PERSON_ORGANIZATION_RELATION_1"(
    prsn_id bigint NOT NULL,
    org_id bigint NOT NULL,
...
Create table ods."PERSON_PAYMENT_OPTIONS_1"(
    prsn_id bigint NOT NULL,
...
Create table ods."PERSON_RELATION_1"(
    prsn_id bigint NOT NULL,
...
Create table ods."PERSON_ROLE_1"(
    prsn_id bigint NOT NULL,
...
Create table ods."PERSON_SUBSIDY_PROFILE_1"(
    prsn_id bigint NOT NULL,
...
Create table ods."PERSON_WORK_ITEM_1"(
    prsn_id bigint NOT NULL,
...
Create table ods."PLAN_MEMBERSHIPS_1"(
    prsn_id bigint NOT NULL,
    bene_grp_id bigint NOT NULL,
...
Create table ods."POSTAL_ADDRESS_1"(
    cntc_id bigint NOT NULL,
...
Create table ods."PROCEDURE_CODE_1"(
...
Create table ods."REFERENCE_DATA_1"(
...
Create table ods."RETURNED_MAIL_1"(
...
Create table ods."UNAPPLIED_CASH_1"(
...
Create table ods."BANK_ACCOUNT_1"(
    bnk_org_id bigint NOT NULL,
    bnk_id bigint NOT NULL,
    bnk_acct_id bigint NOT NULL,
    ver bigint NOT NULL,
...
Create table ods."BENEFIT_PACKAGE_RELATION_1"(
    bene_pkg_id bigint NOT NULL,
...
Create table ods."BILLING_ENTITY_CONTACT_1"(
    bill_ent_id bigint NOT NULL,
    cntc_id bigint NOT NULL,
...
Create table ods."BILLING_ENTITY_DETAIL_1"(
    bill_ent_id bigint NOT NULL,
    client_id bigint NOT NULL,
    ver bigint NOT NULL,
...
Create table ods."BILLING_ENTITY_SCHEDULE_1"(
    bill_ent_id bigint NOT NULL,
    bill_schd_id bigint NOT NULL,
    bill_ent_schd_id bigint NOT NULL,
    ver bigint NOT NULL,
...
Create table ods."CHECK_STATUS_1"(
    clm_pay_id bigint NOT NULL,
    chk_id bigint NOT NULL,
...
Create table ods."CLAIM_ADDITIONAL_DIAGNOSIS_1"(
    prsn_id bigint NOT NULL,
    clm_id bigint NOT NULL,
    clm_add_diag_id bigint NOT NULL,
    client_id bigint NOT NULL,
...
Create table ods."CLAIM_DETAIL_1"(
    prsn_id bigint NOT NULL,
    clm_id bigint NOT NULL,
    seq_num INTEGER NOT NULL,
...
Create table ods."CLAIM_PAYMENT_1"(
    clm_pay_id bigint NOT NULL,
    ver bigint NOT NULL,
    client_id bigint NOT NULL,
    clm_pay_dt DATE,
...
Create table ods."CLAIM_PAYMENT_DETAIL_1"(
    prsn_id bigint NOT NULL,
    clm_id bigint NOT NULL,
    clm_pay_id bigint NOT NULL,
...
Create table ods."CLAIM_PAYMENT_REDUCTION_1"(
...
Create table ods."CLAIM_REDUCTION_DETAIL_1"(
    prsn_id bigint NOT NULL,
    clm_id bigint NOT NULL,
    clm_pay_rdctn_id bigint NOT NULL,
...
Create table ods."CLAIM_REDUCTION_HISTORY_1"(
    clm_pay_rdctn_id bigint NOT NULL,
...
Create table ods."CLAIM_STATUS_1"(
    prsn_id bigint NOT NULL,
    clm_id bigint NOT NULL,
    seq_num INTEGER NOT NULL,
...
Create table ods."COMPLAINT_STATUS_1"(
    inq_id bigint NOT NULL,
    complaint_id bigint NOT NULL,
...
Create table ods."CONTACT_TYPE_CONTACT_1"(
    cntc_id bigint NOT NULL,
    org_cntc_typ_id bigint NOT NULL,
...
Create table ods."EXHIBIT_GROUP_1"(
...
Create table ods."EXHIBIT_GROUP_EXHIBIT_1"(
    exhibit_id bigint NOT NULL,
    exhibit_grp_id bigint NOT NULL,
...
Create table ods."GENERAL_LEDGER_MAP_1"(
    gl_map_id bigint NOT NULL,
    ver bigint NOT NULL,
...
Create table ods."INVOICE_DETAIL_1"(
    bill_ent_id bigint NOT NULL,
    inv_id bigint NOT NULL,
...
Create table ods."INVOICE_STATUS_1"(
    bill_ent_id bigint NOT NULL,
    inv_id bigint NOT NULL,
...
Create table ods."LEP_APPEAL_DECISION_1"(
    prsn_id bigint NOT NULL,
    lep_apl_id bigint NOT NULL,
...
Create table ods."LETTER_DETAIL_1"(
    prsn_id bigint NOT NULL,
    ltr_id bigint NOT NULL,
...
Create table ods."LETTER_REGISTER_1"(
    prsn_id bigint NOT NULL,
    ltr_id bigint NOT NULL,
...
Create table ods."LETTER_WORK_ITEM_1"(
    prsn_id bigint NOT NULL,
    ltr_rgstr_id bigint NOT NULL,
    prsn_wrk_itm_id bigint NOT NULL,
...
Create table ods."PERSON_EVENT_ATTRIBUTE_1"(
    prsn_evnt_id bigint NOT NULL,
...
Create table ods."PERSON_EVENT_STATUS_1"(
    prsn_evnt_id bigint NOT NULL,
...
Create table ods."PERSON_EVENT_STATUS_REASON_1"(
    prsn_evnt_stat_id bigint NOT NULL,
...
Create table ods."PERSON_LEP_PROFILE_RECORD_1"(
    prsn_id bigint NOT NULL,
    prsn_lep_prfl_id bigint NOT NULL,
...
Create table ods."PREMIUM_CATEGORY_1"(
    grp_id bigint NOT NULL,
    prem_cat_id bigint NOT NULL,
    ver bigint NOT NULL,
    client_id bigint NOT NULL,
...
Create table ods."PREMIUM_PART_1"(
    grp_id bigint NOT NULL,
    prem_part_id bigint NOT NULL,
    ver bigint NOT NULL,
    client_id bigint NOT NULL,
...
Create table ods."PREMIUM_TABLE_1"(
    grp_id bigint NOT NULL,
    bene_grp_id bigint NOT NULL,
    prem_tbl_id bigint NOT NULL,
    ver bigint NOT NULL,
...
Create table ods."TOPIC_COMMUNICATION_1"(
    ...
    src_sys_ref_id varchar(10) NOT NULL,
    src_sys_rec_id varchar(150),
    PRIMARY KEY (client_id,cmcn_inq_id,tpc_inquire_id,cmcn_id,tpc_id)
)
PARTITION BY COLUMN (client_id)
COLOCATE WITH (ods."CLIENTS_1")
REDUNDANCY 1
